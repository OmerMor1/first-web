            ...
            <div className="container">
                <div className="right">
                    ...
                    <div className="item">
                        ...
                        <h4>חי ונושם את עולם החשמל ומעל ל-30 שנים בתחום!</h4>

                    </div>
                    <div className="item">
                        <ElectricBoltIcon className="icon"/>
                        <h4>בעל רישיון חשמלאי ראשי המדורג כגבוה ביותר.</h4>
                    ...
                    <div className="item">
                        <ElectricBoltIcon className="icon"/>
                        <h4>מספק שירות תיקונים ללקוחות פרטיים ולעסקים.</h4>
                    </div>
                    <hr />
                    <p> 
...
כל עבודות החשמל שהצוות מבצע, מתבצעות תחת כל התקנים הכי מחמירים של חברת החשמל גם מבחינת ביצוע העבודה וגם מבחינת חומרי החשמל בהם משתמשים.
                    ...
                    <br/>
ראשית אני בתחום כבר מעל ל-30 שנים, במהלך שנים אלו התנסתי רבות בתקלות ובבעיות במערכת החשמל השונות והוסמכתי כחשמלאי ראשי, כלומר אני רשאי לבצע את כל עבודות החשמל שישנן ובכל עוצמת חשמל שהיא.
<br/>
 צוות ק.מור מחוייב לשמור על לקוחותינו מרוצים ולכן תמיד נפעל בהגינות ובשקיפות מלאה. הצוות דוגל בשירות מקצועי ואדיב ללקוחות פרטיים ועסקיים כאחד. <br/>אתם מוזמנים לפנות לייעוץ והכוונה בחינם בכל כעת 054-2266-843.
                    ...
                    <p>
                    רבים מאיתנו תוהים האם בכל תקלה חובה להזמין חשמלאי באור יהודה או שאפשר ללנסות ולתקן בעצמנו את התקלה, הובכן הכן חובה! לא תמיד התקלות הן גדולות, לעיתים מדובר בשקע חשוף, חוט קטן שהשתחרר או כל דבר שנראה לנו פשוט וקל לתקן,

כשמדובר בחשמל הסכנה היא גדולה, אדם בלתי מיומן ומוסמך אינו יכול להבחין בסקנות העורבות מהתעסקות בחשמל.  <br/> ישנם מקרים רבים שנגמרו באסון שיכול היה להמנע לולא היה טיפול של חשמלאי מוסמך,
