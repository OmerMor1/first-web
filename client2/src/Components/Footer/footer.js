...
function footer(){
    return(
        <div className="footer">
            <div className="right">
                <h2>קובי מור</h2>
                <h3>חשמלאי ראשי ומקצועי</h3>
                <p>זקוקים לעבודות חשמל? קבלן חשמל?
                 קובי מור חשמלאי ראשי לשרותכם,
                  מומחה בכל עבודות חשמל הדרושות, תכנון חשמל לבית, תיקון קצרים, התקנת לוחות חשמל,
                  טיפול בשקעים,קדיחה וחציבה בבטון, התקנת תאורה לבית ולגינה.
                  </p>
